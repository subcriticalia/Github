...
derive_pll_clocks 
create_generated_clock -name sd1clk_pin -source [get_pins {mypll|altpll_component|pll|clk[1]}] [get_ports {sdram_clk_o}]
...
set_input_delay -clock sysclock -min 0.5 [get_ports sd_miso_i]
set_input_delay -clock sysclock -max 1.0 [get_ports sd_miso_i]
